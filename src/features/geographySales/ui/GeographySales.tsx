...
import map from 'src/shared/images/map.jpg';
import dot from 'src/shared/images/dot.svg';
import scale from 'src/shared/images/scale.svg';
...
function GeographySales() {
  ...
  return (
    <div className={geographySales.body}>
      <h3 className={geographySales.title}>география</h3>
      ...
      <div className={geographySales.box}>
        <div className={geographySales.btns}>
          <button
            className={geographySales.btnLittle}
          ...
          <button
            className={`${geographySales.btnBig} ${geographySales.btnActive}`}
            onClick={classAssignmentBtn}
            type="button"
            ref={refBtnAll}
          >
